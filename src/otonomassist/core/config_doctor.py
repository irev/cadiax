...
def get_config_status_report() -> str:
    ...
    if data["issues"]:
        lines.append("- Jalankan `autonomiq setup` untuk memperbaiki konfigurasi inti.")
    else:
        lines.append("- Konfigurasi inti terlihat sehat. Gunakan `autonomiq setup` bila ingin reconfigure.")
