...
from cadiax.core.agent_context import DATA_DIR, ensure_agent_storage, get_secret_value
    ...
    def _handle_control_command(
        ...
        if text == "/start":
            if self._is_dm_allowed(chat_id, user_id, silent=True) or self._is_group_allowed(
                ...
                self._send_message(chat_id, "Cadiax Telegram siap. Kirim pesan untuk mulai.")
            else:
