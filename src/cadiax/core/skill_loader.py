...
from cadiax.core.external_assets import get_external_skills_dir, is_external_skill_approved
from cadiax.models import Skill, SkillDefinition
from cadiax.platform import run_process
...
class SkillLoader:
    ...
    def _build_external_handler(self, skill_dir: Path, handler_path: Path, skill_name: str):
        ...
        runner_spec = importlib.util.find_spec("cadiax.platform.external_skill_runner")
