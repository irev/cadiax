...
def get_config_status_report() -> str:
    ...
    if data["issues"]:
        lines.append("- Jalankan `cadiax setup` untuk membuka TUI setup dan memperbaiki konfigurasi inti.")
    else:
        lines.append("- Konfigurasi inti terlihat sehat. Gunakan `cadiax setup` bila ingin reconfigure lewat TUI.")
