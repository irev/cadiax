...
from cadiax import __version__
from cadiax.core import (
    Assistant,
    TransportContext,
...
from cadiax.core.external_installer import install_external_skill, render_external_install_result
from cadiax.core.workspace_bootstrap import (
...
from cadiax.services.interactions import ConversationService, NotificationDispatcher, run_conversation_api
from cadiax.telegram_cli import run_telegram_transport
...
@click.option(
    "--screen",
    type=click.Choice(
        ["home", "paths", "doctor", "channels", "services", "worker", "scheduler", "startup", "setup", "jobs", "metrics", "history", "events"],
